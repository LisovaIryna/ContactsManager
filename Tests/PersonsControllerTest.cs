...
public class PersonsControllerTest
{
    ...
    public PersonsControllerTest()
    {
        ...
        _countriesGetterServiceMock = new();
    ...
    public async Task Index_ShouldReturnIndexViewWithPersonsList()
    {
        ...
        PersonsController personsController = new(_personsGetterService, _personsAdderService, _personsUpdaterService, _personsDeleterService, _personsSorterService, _countriesGetterService, _logger);
